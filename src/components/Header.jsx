...
const Header = () => {
    ...
    return(
        <div className="flex items-center py-4 px-8 justify-between">
            <div className="flex text-xl items-center justify-around md:justify-between w-[70%]">
                ...
                <ul className=" justify-start gap-7 cursor-pointer w-[60%] items-center hidden md:flex">
            ...
            <div>
                <ul className="flex items-center vsm:text-xl gap-8">
                    <li onClick={() => navigate("/liked")} className="bg-[#4444dd] text-white rounded-md py-3 vsm:min-w-[160px] cursor-pointer text-center">Liked Property</li>
                </ul>
            </div>
        </div>
    )
